          ...
          <div className="row no-gutters mx-0 flex-column-reverse flex-lg-row">
            ...
            <div className="block col-lg-6 px-0">
              <div className="block__text">
                ...
                <p className="block__para block__para-hours">Tuesday 4 pm - 10 pm</p>
                <p className="block__para block__para-hours">Wednesday to Saturday 12 pm - Late</p>
                <p className="block__para block__para-hours">Sunday 12 pm - 11 pm</p>
              </div>
            </div>
          </div>
        </div>
